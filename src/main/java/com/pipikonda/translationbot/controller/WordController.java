...
import com.pipikonda.translationbot.controller.dto.GetRandomWordDto;
...
public class WordController {
    ...
    @GetMapping("/api/user/word/random")
    public Response<String> getRandomWord(@Valid GetRandomWordDto dto) {
        return null;
    }
